...
func TestDataMasking(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected:   `{"body":"{\"credit_card\":\"this is a credit card [MASKED_CC]\",\"crypto_wallet\":\"[MASKED_WALLET]\",\"email\":\"[MASKED_EMAIL]\",\"iban\":\"[MASKED_IBAN]\",\"secret_key\":\"and my **** is this_is_secret\",\"stripe_key\":\"I logged in using the API key: [MASKED_API_KEY]\",\"tax_id\":\"[MASKED_TAX_ID]\"}"}`,
...
func TestDataMaskingApplyAll(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			...
			expected:   `{"body":"{\"credit_card\":\"this is a credit card *****\",\"crypto_wallet\":\"*****\",\"email\":\"*****\",\"iban\":\"*****\",\"secret_key\":\"and my **** is this_is_secret\",\"stripe_key\":\"I logged in using the API key: *****\",\"tax_id\":\"*****\"}"}`,
			expectCode: http.StatusOK,
		},
	}
	for _, tc := range testCases {
