          ...
          {type === "oauth2" && (
            <>
              ...
              <Section title="OAuth2">
                ...
                <Grid2>
                  <Field label="JWKS URL" hint="or introspection, or public keys below">
                ...
                <Field label="Public keys (PEM)" hint="one or more, as an alternative to JWKS">
                  <textarea
                    value={publicKeys}
