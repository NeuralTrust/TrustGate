...
func (_m *Repository) Create(ctx context.Context, _a1 *service.Service) error {
	...
	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, *service.Service) error); ok {
		r0 = rf(ctx, _a1)
	} else {
		r0 = ret.Error(0)
	}
...
func (_c *Repository_Create_Call) Run(run func(ctx context.Context, _a1 *service.Service)) *Repository_Create_Call {
...
func (_c *Repository_Create_Call) RunAndReturn(run func(context.Context, *service.Service) error) *Repository_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Repository) Get(ctx context.Context, id string) (*service.Service, error) {
	ret := _m.Called(ctx, id)
...
func (_c *Repository_Get_Call) Return(_a0 *service.Service, _a1 error) *Repository_Get_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_Get_Call) RunAndReturn(run func(context.Context, string) (*service.Service, error)) *Repository_Get_Call {
	_c.Call.Return(run)
	return _c
}

// List provides a mock function with given fields: ctx, gatewayID, offset, limit
func (_m *Repository) List(ctx context.Context, gatewayID uuid.UUID, offset int, limit int) ([]service.Service, error) {
	...
	var r0 []service.Service
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int, int) ([]service.Service, error)); ok {
		return rf(ctx, gatewayID, offset, limit)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, int, int) []service.Service); ok {
...
//   - offset int
//   - limit int
func (_e *Repository_Expecter) List(ctx interface{}, gatewayID interface{}, offset interface{}, limit interface{}) *Repository_List_Call {
	return &Repository_List_Call{Call: _e.mock.On("List", ctx, gatewayID, offset, limit)}
}

func (_c *Repository_List_Call) Run(run func(ctx context.Context, gatewayID uuid.UUID, offset int, limit int)) *Repository_List_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Repository_List_Call) Return(_a0 []service.Service, _a1 error) *Repository_List_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repository_List_Call) RunAndReturn(run func(context.Context, uuid.UUID, int, int) ([]service.Service, error)) *Repository_List_Call {
	_c.Call.Return(run)
	return _c
}

// Update provides a mock function with given fields: ctx, _a1
func (_m *Repository) Update(ctx context.Context, _a1 *service.Service) error {
	ret := _m.Called(ctx, _a1)
...
func (_c *Repository_Update_Call) Run(run func(ctx context.Context, _a1 *service.Service)) *Repository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*service.Service))
	})
	return _c
...
func (_c *Repository_Update_Call) RunAndReturn(run func(context.Context, *service.Service) error) *Repository_Update_Call {
	_c.Call.Return(run)
	return _c
}
