...
type TargetOAuthConfig struct {
	...
	ClientSecret string            `json:"client_secret,omitempty"` // #nosec G117 -- OAuth domain field for client credentials flow
	...
	RefreshToken string            `json:"refresh_token,omitempty"` // #nosec G117 -- OAuth domain field for token refresh flow
	Username     string            `json:"username,omitempty"`
	Password     string            `json:"password,omitempty"` // #nosec G117 -- OAuth domain field for password grant flow
