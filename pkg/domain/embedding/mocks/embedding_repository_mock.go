...
func (_m *Repository) Search(ctx context.Context, index string, query string, embeddingData *embedding.Embedding) ([]embedding.SearchResult, error) {
	ret := _m.Called(ctx, index, query, embeddingData)
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, *embedding.Embedding) error); ok {
		r1 = rf(ctx, index, query, embeddingData)
	} else {
		r1 = ret.Error(1)
	}
...
func (_e *Repository_Expecter) Search(ctx interface{}, index interface{}, query interface{}, embeddingData interface{}) *Repository_Search_Call {
	return &Repository_Search_Call{Call: _e.mock.On("Search", ctx, index, query, embeddingData)}
}
...
func (_m *Repository) StoreWithHMSet(ctx context.Context, index string, key string, gatewayID string, embeddingData *embedding.Embedding, data []byte) error {
	ret := _m.Called(ctx, index, key, gatewayID, embeddingData, data)
	...
	if rf, ok := ret.Get(0).(func(context.Context, string, string, string, *embedding.Embedding, []byte) error); ok {
		r0 = rf(ctx, index, key, gatewayID, embeddingData, data)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *Repository_Expecter) StoreWithHMSet(ctx interface{}, index interface{}, key interface{}, gatewayID interface{}, embeddingData interface{}, data interface{}) *Repository_StoreWithHMSet_Call {
	return &Repository_StoreWithHMSet_Call{Call: _e.mock.On("StoreWithHMSet", ctx, index, key, gatewayID, embeddingData, data)}
}
