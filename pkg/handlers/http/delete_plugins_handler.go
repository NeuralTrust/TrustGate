...
func (h *deletePluginsHandler) handleGatewayDelete(c *fiber.Ctx, req *request.DeletePluginsRequest) error {
	...
	entity, err := h.gatewayRepo.Get(c.UserContext(), gatewayUUID)
	...
	if err := h.pluginChainValidator.Validate(c.UserContext(), gatewayUUID, updated); err != nil {
...
func (h *deletePluginsHandler) handleRuleDelete(c *fiber.Ctx, req *request.DeletePluginsRequest) error {
	...
	rule, err := h.ruleRepo.GetRuleByID(c.UserContext(), ruleUUID)
	if err != nil || rule == nil {
