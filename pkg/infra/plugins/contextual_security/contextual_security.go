...
func (p *ContextualSecurityPlugin) ValidateConfig(config pluginTypes.PluginConfig) error {
	var cfg Config
...
func (p *ContextualSecurityPlugin) Stages() []pluginTypes.Stage {
	return []pluginTypes.Stage{pluginTypes.PreRequest}
}

func (p *ContextualSecurityPlugin) AllowedStages() []pluginTypes.Stage {
	return []pluginTypes.Stage{pluginTypes.PreRequest}
}
