...
func (p *Plugin) Stages() []pluginTypes.Stage { return []pluginTypes.Stage{pluginTypes.PreRequest} }

func (p *Plugin) AllowedStages() []pluginTypes.Stage {
...
func (p *Plugin) Execute(
	...
	if !conf.Enabled {
		return &pluginTypes.PluginResponse{StatusCode: 200, Message: "ip whitelist disabled"}, nil
	}
	...
	if ip == "" {
		...
		return nil, &pluginTypes.PluginError{StatusCode: 403, Message: "forbidden", Err: fmt.Errorf("ip not found")}
	}
	...
	if matched {
		return &pluginTypes.PluginResponse{StatusCode: 200, Message: "ip allowed"}, nil
	}
	return nil, &pluginTypes.PluginError{StatusCode: 403, Message: "forbidden", Err: fmt.Errorf("ip not allowed")}
}
