...
func TestPluginMetadata(t *testing.T) {
	...
	assert.ElementsMatch(t, []pluginTypes.Stage{}, plugin.Stages())
	assert.ElementsMatch(t, []pluginTypes.Stage{pluginTypes.PreRequest, pluginTypes.PostResponse}, plugin.AllowedStages())
}
...
func TestExternalApiPlugin_ValidateConfig_InvalidQueryParams(t *testing.T) {
	...
	invalidConfig1 := pluginTypes.PluginConfig{
		Stage: pluginTypes.PreRequest,
		Settings: map[string]interface{}{
			"endpoint": "https://example.com",
			"query_params": []interface{}{
	...
	invalidConfig2 := pluginTypes.PluginConfig{
		Stage: pluginTypes.PreRequest,
		Settings: map[string]interface{}{
			"endpoint": "https://example.com",
			"query_params": []interface{}{
	...
	invalidConfig3 := pluginTypes.PluginConfig{
		Stage: pluginTypes.PreRequest,
		Settings: map[string]interface{}{
			"endpoint": "https://example.com",
			"query_params": []interface{}{
