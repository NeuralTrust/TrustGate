...
func (p *BotDetectorPlugin) Stages() []pluginTypes.Stage {
	return []pluginTypes.Stage{pluginTypes.PreRequest}
}

func (p *BotDetectorPlugin) AllowedStages() []pluginTypes.Stage {
	return []pluginTypes.Stage{pluginTypes.PreRequest}
}

func (p *BotDetectorPlugin) ValidateConfig(config pluginTypes.PluginConfig) error {
	var cfg Config
