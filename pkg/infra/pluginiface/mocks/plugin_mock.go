...
func (_m *Plugin) Execute(ctx context.Context, cfg types.PluginConfig, req *pkgtypes.RequestContext, resp *pkgtypes.ResponseContext, evtCtx *metrics.EventContext) (*types.PluginResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, types.PluginConfig, *pkgtypes.RequestContext, *pkgtypes.ResponseContext, *metrics.EventContext) (*types.PluginResponse, error)); ok {
		return rf(ctx, cfg, req, resp, evtCtx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, types.PluginConfig, *pkgtypes.RequestContext, *pkgtypes.ResponseContext, *metrics.EventContext) *types.PluginResponse); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, types.PluginConfig, *pkgtypes.RequestContext, *pkgtypes.ResponseContext, *metrics.EventContext) error); ok {
...
func (_c *Plugin_Execute_Call) Run(run func(ctx context.Context, cfg types.PluginConfig, req *pkgtypes.RequestContext, resp *pkgtypes.ResponseContext, evtCtx *metrics.EventContext)) *Plugin_Execute_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(types.PluginConfig), args[2].(*pkgtypes.RequestContext), args[3].(*pkgtypes.ResponseContext), args[4].(*metrics.EventContext))
	})
	return _c
}
...
func (_c *Plugin_Execute_Call) RunAndReturn(run func(context.Context, types.PluginConfig, *pkgtypes.RequestContext, *pkgtypes.ResponseContext, *metrics.EventContext) (*types.PluginResponse, error)) *Plugin_Execute_Call {
	_c.Call.Return(run)
	return _c
}
