...
// Perplexity accepts OpenAI-style POST /chat/completions at the API root:
// /v1/chat/completions returns 404. Confirmed against the live API in July
// 2026. The models listing, in contrast, does sit under /v1.
