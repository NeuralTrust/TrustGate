...
func (_m *Updater) Update(ctx context.Context, in consumer.UpdateInput) (*domainconsumer.Consumer, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, consumer.UpdateInput) (*domainconsumer.Consumer, error)); ok {
		return rf(ctx, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, consumer.UpdateInput) *domainconsumer.Consumer); ok {
		r0 = rf(ctx, in)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, consumer.UpdateInput) error); ok {
		r1 = rf(ctx, in)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Updater_Update_Call) Run(run func(ctx context.Context, in consumer.UpdateInput)) *Updater_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(consumer.UpdateInput))
	})
	return _c
}
