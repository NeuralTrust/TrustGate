...
func (_m *Finder) FindByID(ctx context.Context, id uuid.UUID) (*consumer.Consumer, error) {
...
func (_c *Finder_FindByID_Call) RunAndReturn(run func(context.Context, uuid.UUID) (*consumer.Consumer, error)) *Finder_FindByID_Call {
	_c.Call.Return(run)
	return _c
}
