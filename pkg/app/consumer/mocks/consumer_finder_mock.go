...
func (_m *Finder) FindByID(ctx context.Context, gatewayID ids.ID[ids.GatewayKind], id ids.ID[ids.ConsumerKind]) (*consumer.Consumer, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID[ids.GatewayKind], ids.ID[ids.ConsumerKind]) (*consumer.Consumer, error)); ok {
		return rf(ctx, gatewayID, id)
	}
	if rf, ok := ret.Get(0).(func(context.Context, ids.ID[ids.GatewayKind], ids.ID[ids.ConsumerKind]) *consumer.Consumer); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, ids.ID[ids.GatewayKind], ids.ID[ids.ConsumerKind]) error); ok {
