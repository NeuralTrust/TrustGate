...
func (_m *Creator) Create(ctx context.Context, in consumer.CreateInput) (*domainconsumer.Consumer, error) {
	...
	var r0 *domainconsumer.Consumer
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, consumer.CreateInput) (*domainconsumer.Consumer, error)); ok {
		return rf(ctx, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, consumer.CreateInput) *domainconsumer.Consumer); ok {
		r0 = rf(ctx, in)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domainconsumer.Consumer)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, consumer.CreateInput) error); ok {
		r1 = rf(ctx, in)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Creator_Create_Call) Run(run func(ctx context.Context, in consumer.CreateInput)) *Creator_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(consumer.CreateInput))
	})
	return _c
}
