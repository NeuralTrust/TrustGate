...
const (
	...
	ConsentCauseNoCredential = "no_credential" // #nosec G101 -- consent cause reported to clients, not a credential
	...
	ConsentCauseCredentialVanished = "credential_vanished" // #nosec G101 -- consent cause reported to clients, not a credential
