...
type Introspector interface {
	ListRegistryTools(ctx context.Context, gatewayID ids.GatewayID, registryID ids.RegistryID) ([]mcpclient.Tool, error)
}
...
func (i *introspector) ListRegistryTools(ctx context.Context, gatewayID ids.GatewayID, registryID ids.RegistryID) ([]mcpclient.Tool, error) {
	...
	up, err := i.dialer.Connect(ctx, Target(reg))
	if err != nil {
