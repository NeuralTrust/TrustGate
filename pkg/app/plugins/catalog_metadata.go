			...
			Fields: []Field{
				{
					...
					Label:       "Compress JSON",
					Type:        FieldTypeBoolean,
					Description: "Minify standalone JSON message content, fenced ```json blocks, and tool-call arguments. Whitespace-only and fully lossless.",
					Default:     true,
				},
				{
				...
				},
				{
					...
					Type:        FieldTypeBoolean,
					Description: "Remove ANSI color and cursor escape sequences, common in captured terminal and CI log output.",
					Default:     true,
				},
				{
				...
				},
				{
					...
					Label:       "Target Roles",
					Type:        FieldTypeArray,
					Description: "Restrict compression to messages with these roles (e.g. tool, user, system). Empty compresses every role.",
					Item:        &Field{Key: "role", Label: "Role", Type: FieldTypeString},
				},
			},
		},
	},
