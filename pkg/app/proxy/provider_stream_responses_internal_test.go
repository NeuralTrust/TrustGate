...
func requireResponsesContract(t *testing.T, events []responsesWireEvent) *responsesWireResponse {
	...
	require.Contains(t, []string{"response.completed", "response.incomplete"}, last.Type)
	...
	return []responsesStreamCase{
		{
			...
			wantText:  "Hello",
			wantUsage: `{"input_tokens":5,"output_tokens":2,"total_tokens":7}`,
		},
		{
			...
			wantUsage: `{"input_tokens":9,"output_tokens":4,"total_tokens":13}`,
		},
		{
		...
		},
		{
			...
			wantUsage: `{"input_tokens":1010,"output_tokens":20,"total_tokens":1030,"input_tokens_details":{"cached_tokens":1000}}`,
		},
		{
			...
			wantUsage: `{"input_tokens":10,"output_tokens":7,"total_tokens":17}`,
		},
		{
			...
			wantUsage: `{"input_tokens":60,"output_tokens":30,"total_tokens":90}`,
		},
		{
			...
			wantUsage: `{"input_tokens":20,"output_tokens":10,"total_tokens":30}`,
		},
		{
			...
			wantUsage: `{"input_tokens":793,"output_tokens":61,"total_tokens":854,"input_tokens_details":{"cached_tokens":176}}`,
		},
	}
}
