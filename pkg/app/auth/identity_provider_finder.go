...
// ErrInvalidAuthRequest identifies malformed or unsupported authentication requests.
var ErrInvalidAuthRequest = errors.New("invalid auth request")

// IdentityProviderFinder selects enabled providers matching a token's unverified hints.
//
