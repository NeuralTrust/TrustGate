...
// DefaultOAuth2ForGateway returns the built-in provider bound to the addressed gateway.
...
// OAuth2AuthsForGateway returns the gateway's enabled OAuth2 configurations for login selection.
