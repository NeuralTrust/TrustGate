...
func (_m *Updater) Update(ctx context.Context, in role.UpdateInput) (*domainrole.Role, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, role.UpdateInput) (*domainrole.Role, error)); ok {
		return rf(ctx, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, role.UpdateInput) *domainrole.Role); ok {
		r0 = rf(ctx, in)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, role.UpdateInput) error); ok {
		r1 = rf(ctx, in)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Updater_Update_Call) Run(run func(ctx context.Context, in role.UpdateInput)) *Updater_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(role.UpdateInput))
	})
	return _c
}

func (_c *Updater_Update_Call) Return(_a0 *domainrole.Role, _a1 error) *Updater_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Updater_Update_Call) RunAndReturn(run func(context.Context, role.UpdateInput) (*domainrole.Role, error)) *Updater_Update_Call {
	_c.Call.Return(run)
	return _c
}
