...
func (_m *Creator) Create(ctx context.Context, in role.CreateInput) (*domainrole.Role, error) {
	...
	var r0 *domainrole.Role
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, role.CreateInput) (*domainrole.Role, error)); ok {
		return rf(ctx, in)
	}
	if rf, ok := ret.Get(0).(func(context.Context, role.CreateInput) *domainrole.Role); ok {
		r0 = rf(ctx, in)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*domainrole.Role)
		}
	}

	if rf, ok := ret.Get(1).(func(context.Context, role.CreateInput) error); ok {
		r1 = rf(ctx, in)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Creator_Create_Call) Run(run func(ctx context.Context, in role.CreateInput)) *Creator_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(role.CreateInput))
	})
	return _c
}

func (_c *Creator_Create_Call) Return(_a0 *domainrole.Role, _a1 error) *Creator_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Creator_Create_Call) RunAndReturn(run func(context.Context, role.CreateInput) (*domainrole.Role, error)) *Creator_Create_Call {
	_c.Call.Return(run)
	return _c
}
