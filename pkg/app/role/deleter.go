...
//go:generate mockery --name=Deleter --dir=. --output=./mocks --filename=role_deleter_mock.go --case=underscore --with-expecter
...
func (d *deleter) Delete(ctx context.Context, gatewayID ids.GatewayID, id ids.RoleID) error {
