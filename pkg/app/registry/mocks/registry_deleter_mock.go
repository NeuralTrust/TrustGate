...
func (_m *Deleter) Delete(ctx context.Context, gatewayID ids.ID[ids.GatewayKind], id ids.ID[ids.RegistryKind]) error {
...
func (_c *Deleter_Delete_Call) Run(run func(ctx context.Context, gatewayID ids.ID[ids.GatewayKind], id ids.ID[ids.RegistryKind])) *Deleter_Delete_Call {
...
func (_c *Deleter_Delete_Call) RunAndReturn(run func(context.Context, ids.ID[ids.GatewayKind], ids.ID[ids.RegistryKind]) error) *Deleter_Delete_Call {
	_c.Call.Return(run)
	return _c
}
