...
func (m *pluginMiddleware) convertGatewayPlugins(gateway *types.GatewayDTO) []pluginTypes.PluginConfig {
	chains := make([]pluginTypes.PluginConfig, 0, len(gateway.RequiredPlugins))
