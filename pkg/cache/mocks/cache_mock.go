...
func (_m *Cache) InvalidateAll(ctx context.Context) error {
	ret := _m.Called(ctx)
...
//   - ctx context.Context
func (_e *Cache_Expecter) InvalidateAll(ctx interface{}) *Cache_InvalidateAll_Call {
	return &Cache_InvalidateAll_Call{Call: _e.mock.On("InvalidateAll", ctx)}
}

func (_c *Cache_InvalidateAll_Call) Run(run func(ctx context.Context)) *Cache_InvalidateAll_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Cache_InvalidateAll_Call) Return(_a0 error) *Cache_InvalidateAll_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Cache_InvalidateAll_Call) RunAndReturn(run func(context.Context) error) *Cache_InvalidateAll_Call {
	_c.Call.Return(run)
	return _c
}
