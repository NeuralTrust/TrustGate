# Spec: run-1102-mcp-tasks-extension
...
**Contract**: `io.modelcontextprotocol/tasks` draft (SEP-2663), revision pinned in the domain spec.

## Domain: mcp-tasks-extension (new)
