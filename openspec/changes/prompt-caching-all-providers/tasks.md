...
- [ ] 9.6 V1 (adapter, `pkg/infra/plugins/...`); V2; V3; V4 **Anthropic, OpenAI, openai_responses** (plugin cases) plus Bedrock for bedrockguardrail; V5. *(V1 done: gofmt, vet, golangci-lint 0 issues on adapter + plugins, race tests providers+plugins+proxy, `go test ./pkg/...`; V2-V5 pending.)*
